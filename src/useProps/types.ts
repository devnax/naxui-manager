...
interface CSSProperties {
    ...
    background: CSSValueType<"background">;
    backgroundAttachment: CSSValueType<"backgroundAttachment">;
    backgroundColor: CSSValueType<"backgroundColor">;
    ...
    borderBottomColor: CSSValueType<"borderBottomColor">;
    ...
    borderLeftColor: CSSValueType<"borderLeftColor">;
    ...
    borderRightColor: CSSValueType<"borderRightColor">;
    ...
    borderTopColor: CSSValueType<"borderTopColor">;
...
export type CSSPropAsAttr = Partial<CSSProperties> & AliasesTypes & {
    ...
    baseClass?: string;
    disabled?: boolean;
    typography?: keyof Omit<ThemeOptions['typography'], "fontSize" | "fontFamily" | "sizes">;
